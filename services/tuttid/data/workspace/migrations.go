...
const schemaMigrationDesktopPreferencesAgentSessionLaunchModesV1 = "desktop_preferences_agent_session_launch_modes_v1"
...
const schemaMigrationDesktopPreferencesTuttiModeDefaultOffV1 = "desktop_preferences_tutti_mode_default_off_v1"
...
`, schemaMigrationWorkspacesV1, unixMs(time.Now().UTC()))
	...
	if err := s.applyDesktopPreferencesMigrations(ctx); err != nil {
		return err
	}
	...
	if err := s.applyAgentSessionReplayV3(ctx); err != nil {
		return err
	}
