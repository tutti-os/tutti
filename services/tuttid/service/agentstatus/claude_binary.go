...
// a pointer file consumed by agentsidecar's ClaudeCodePreparer, which emits
// TUTTI_CLAUDE_CODE_FALLBACK_EXECUTABLE for the sidecar (see
// services/tuttid/service/agentsidecar/claude.go — keep the pointer path contract in
...
const (
	...
	// claudeCodePointerFileName is the pointer consumed by agentsidecar's
