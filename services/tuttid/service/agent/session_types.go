...
type TuttiModeActivationPort interface {
	...
	Prepare(context.Context, tuttimodeactivationservice.SetInput, string) (tuttimodeactivationservice.SetResult, error)
	Accept(context.Context, string, string) (bool, error)
	Abandon(context.Context, string, string) (bool, error)
