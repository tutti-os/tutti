...
func newApplicationHost(s *Service, worktreeGC agenthost.WorktreeGarbageCollector) *agenthost.Host {
	...
	return agenthost.New(agenthost.Config{
		...
		OperationOwner: s.RuntimeOperationOwner, EventSubscriptions: s.EventSubscriptionStore,
		EventDeliveryOwner: s.EventDeliveryOwner, StaleTurnSettler: s.StaleTurnSettler,
