...
const schemaMigrationWorkspaceAgentTurnLineageV2 = "workspace_agent_turn_lineage_v2"
...
`); err != nil {
	...
	if err := s.applyWorkspaceAgentTurnLineageV1(ctx); err != nil {
		return err
	}
	return s.applyWorkspaceAgentTurnLineageV2(ctx)
}
