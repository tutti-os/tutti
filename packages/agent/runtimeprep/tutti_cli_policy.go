...
func providerSpecificExecutionEnvironment(provider string, cliCommand string) string {
	...
	// Agent extensions (acp:<key>) are CLI-driven like the providers below
	// and share the localhost/IPC execution requirement.
	...
	case "cursor", "cursor-agent", "hermes", "hermes-agent", "nexight", "tutti", "openclaw", "open-claw", "opencode", "open-code", "tutti-agent", "acp":
