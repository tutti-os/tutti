export const zhCNAgentGuiRuntimeNotices = {
  ...
  updateNoticeCompleted: "已更新到 {{version}}",
  updateNoticeCompletedTitle: "{{agent}} 更新成功",
  updateNoticeDetails: "查看详情",
  updateNoticeFailed: "更新失败",
  updateNoticeLater: "稍后处理",
  updateNoticeRegionLabel: "Agent CLI 更新",
  updateNoticeRetry: "重试",
  updateNoticeTitle: "{{agent}} 有新版本可用",
  updateNoticeUpdate: "更新",
  updateNoticeUpdating: "更新中…",
  updateNoticeVersions: "当前 {{current}} · 可用 {{latest}}",
