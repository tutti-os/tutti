...
export const enAgentGui = {
  ...
  contextPickerBrowseModelHint:
    "Type to search models from enabled model plans",
  ...
  mentionEmptyModels: "No enabled model plans yet",
