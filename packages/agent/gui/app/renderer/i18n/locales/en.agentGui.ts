...
export const enAgentGui = {
  ...
  turnDurationMinutes: "{{minutes}}m",
  turnDurationMinutesSeconds: "{{minutes}}m {{seconds}}s",
  turnStageBreakdown: "Turn timing breakdown",
  turnStageStartup: "Start {{duration}}",
  turnStageFirstResponse: "First response {{duration}}",
  turnStageGeneration: "Generate {{duration}}",
  turnStageFinalization: "Finalize {{duration}}",
