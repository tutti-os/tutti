...
export const enAgentGui = {
  ...
  slashCommandHelpDescription: "Show available commands and help.",
  slashCommandInitDescription: "Initialize repository guidance files.",
  slashCommandMcpDescription: "Manage MCP servers.",
  ...
  slashCommandTasksDescription: "View and manage background tasks.",
