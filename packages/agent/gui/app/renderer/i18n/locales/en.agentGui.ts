...
export const enAgentGui = {
  ...
  processingPreparing: "Preparing",
  processingSubmitting: "Submitting",
  processingWaitingResponse: "Waiting for response",
  processingThinking: "Thinking",
  processingGenerating: "Generating response",
  processingUsingTool: "Using a tool",
  processingWaitingTool: "Waiting for tool result",
  processingReconnecting: "Reconnecting",
  processingWaitingContinuation: "Waiting for more response",
  processingElapsedSeconds: "{{seconds}}s",
