...
export const enAgentGui = {
  ...
  updateNoticeCompleted: "Updated to {{version}}",
  updateNoticeCompletedTitle: "{{agent}} updated successfully",
  updateNoticeDetails: "View details",
  updateNoticeFailed: "Update failed",
  updateNoticeLater: "Later",
  updateNoticeRegionLabel: "Agent CLI updates",
  updateNoticeRetry: "Retry",
  updateNoticeTitle: "A new version of {{agent}} is available",
  updateNoticeUpdate: "Update",
  updateNoticeUpdating: "Updating…",
  updateNoticeVersions: "Current {{current}} · Available {{latest}}",
