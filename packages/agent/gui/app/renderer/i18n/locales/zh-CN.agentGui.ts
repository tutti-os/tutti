...
export const zhCNAgentGui = {
  ...
  goalRemoved: "目标已移除",
  turnProgressAwaiting: "等待回应",
  turnProgressStreaming: "回应中",
  turnDurationShortSeconds: "{{seconds}} 秒",
  turnDurationShortMinutes: "{{minutes}} 分钟",
  turnDurationShortMinutesSeconds: "{{minutes}} 分 {{seconds}} 秒",
