...
export const zhCNAgentGui = {
  ...
  editRetryRolloutDisabled: "当前灰度未启用编辑并重试",
  editRetryProviderUnsupported: "此提供方不支持编辑并重试",
  editRetryProviderOutcomeUnknown: "正在确认提供方处理结果",
  editRetryReplacementNotProvenAbsent: "尚未确认替换消息不存在",
  editRetryBudgetExhausted: "自动恢复已达到安全限制",
  editRetryLocalStateInconsistent: "此会话需要本地恢复检查",
  editRetryRecoveryRequired: "此会话需要恢复操作",
  editRetryCurrentSessionOnly: "仅影响此会话",
  editRetryAutomatic: "自动恢复",
  editRetryAttempt: "第 {{attempt}} 次尝试",
  editRetryNextAttempt: "下次尝试 {{time}}",
  editRetryReconcile: "核对状态",
  editRetryRetryReplacement: "重试消息",
  editRetryAbandon: "放弃恢复",
  editRetryActionFailed: "恢复请求失败，可重试",
  editRetryActionRefreshing: "状态已变化，正在刷新",
  messageCopied: "已复制",
