...
export const zhCNAgentGui = {
  ...
  tuttiBudgetModelStrengthPowerful: "最强可用",
  ...
  turnDurationMinutes: "{{minutes}} 分钟",
  turnDurationMinutesSeconds: "{{minutes}} 分 {{seconds}} 秒",
  turnStageBreakdown: "阶段耗时",
  turnStageStartup: "启动 {{duration}}",
  turnStageFirstResponse: "首响 {{duration}}",
  turnStageGeneration: "生成 {{duration}}",
  turnStageFinalization: "收尾 {{duration}}",
