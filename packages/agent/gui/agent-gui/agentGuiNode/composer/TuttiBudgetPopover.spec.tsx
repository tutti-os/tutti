...
describe("TuttiBudgetPopover", () => {
  it("opens on chip click with a slider seeded from the effective intensity", () => {
  ...
  it("escape closes only the popup and prevents the default so it cannot leak", () => {
    ...
    // fireEvent returns false when a handler called preventDefault, proving
    // the escape settled inside the popup instead of reaching other layers.
