...
export function useAgentGUIDetailModel(input: Input) {
  ...
  const interactivePromptLabels = useMemo(
    () => ({
      ...
      planIssueCreateAndStartParallel: labels.planIssueCreateAndStartParallel,
    ...
    [
      ...
      labels.planIssueReasoning,
      labels.planIssueOrchestration,
      labels.planIssueBudgetAuto,
      labels.planIssueBudgetFixed,
      labels.planIssueTokenBudget,
      labels.planIssueTaskPreview,
      labels.planIssueAgentTarget,
      labels.planIssueModelPlan,
      labels.planIssueModel,
      labels.planIssueDirectory,
      labels.planIssueDependencies,
      labels.planIssueCreateOnly,
      labels.planIssueCreateAndStart,
      labels.planIssueCreateAndStartParallel,
      labels.planIssueStartOrchestration,
      labels.planIssueEstimatedCost,
      labels.planIssueCostUnavailable,
      labels.planIssueCostPartial,
      labels.planIssueUnassigned,
      labels.planImplementationFeedbackPlaceholder,
  ...
  const composerLabels = useMemo(
    () => ({
      ...
      ultraPlanModeLabel: labels.ultraPlanModeLabel,
      ultraPlanModeDescription: labels.ultraPlanModeDescription,
      ...
      planIssuePresetLabel: labels.planIssuePresetLabel,
    ...
    [
      ...
      labels.ultraPlanModeDescription,
