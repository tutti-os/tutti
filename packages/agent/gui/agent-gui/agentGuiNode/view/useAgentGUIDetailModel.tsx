...
export function useAgentGUIDetailModel(input: Input) {
  ...
  const composerLabels = useMemo(
    () => ({
      ...
      slashCommandHelpLabel: labels.slashCommandHelpLabel,
      slashCommandInitLabel: labels.slashCommandInitLabel,
      slashCommandMcpLabel: labels.slashCommandMcpLabel,
      ...
      slashCommandTasksLabel: labels.slashCommandTasksLabel,
      ...
      slashCommandHelpDescription: labels.slashCommandHelpDescription,
      slashCommandInitDescription: labels.slashCommandInitDescription,
      slashCommandMcpDescription: labels.slashCommandMcpDescription,
      ...
      slashCommandTasksDescription: labels.slashCommandTasksDescription,
