...
const issueManagerEn = {
  actions: {
    ...
    modifyInMainConversation: "Modify in main conversation",
  ...
  composer: {
    dependenciesPlaceholder: "Comma-separated task IDs",
    executionDirectoryPlaceholder: "Workspace or project path",
    ...
    modelPlanPlaceholder: "Optional Model Plan ID",
  ...
  labels: {
    ...
    budgetFixed: "Fixed token limit",
    budgetMode: "Budget mode",
    budgetRecoveryRearrangeHint:
      "Saving keeps dispatch paused. Reassign or break down the remaining tasks under the lower intensities, then resume dispatch.",
    content: "Content",
    ...
    dispatchPaused: "Pause future dispatch",
    dispatchPausedDescription:
      "Running work continues. No new task starts until you resume dispatch.",
    executionAssignment: "Execution assignment",
    ...
    managedReadOnly: "Managed by Tutti",
    model: "Model",
    modelPlan: "Model Plan",
    orchestrationIntensity: "Orchestration intensity (0–100)",
    outputs: "Outputs",
    parallelizable: "Parallel",
    priority: "Priority",
    provider: "Provider",
    recentRuns: "Recent runs",
    quotaWaterline: "Subscription quota waterline (%)",
    reasoningIntensity: "Reasoning intensity (0–100)",
  ...
  messages: {
    ...
    managedReadOnlyTooltip:
      "This task is managed by Tutti. Make changes in its source conversation.",
    managedSourceUnavailable: "The source conversation is unavailable.",
    modifyManagedPrompt:
      "Please modify {{reference}} in this Tutti plan. Keep the existing plan context and do not execute it yet.",
...
const issueManagerZhCN = {
  actions: {
    ...
    minimizeWindow: "最小化",
    moreActions: "更多操作",
    modifyInMainConversation: "在主对话中修改",
  ...
  composer: {
    dependenciesPlaceholder: "用逗号分隔任务 ID",
    executionDirectoryPlaceholder: "工作区或项目路径",
    issueContentPlaceholder: "补充这个任务的背景、目标或上下文",
    issueTitlePlaceholder: "任务标题",
    modelPlaceholder: "可选模型 ID",
    modelPlanPlaceholder: "可选 Model Plan ID",
  ...
  labels: {
    ...
    budgetMode: "预算模式",
    budgetRecoveryRearrangeHint:
      "保存后调度仍会暂停。请按较低强度重新分配或拆解剩余任务，然后再恢复调度",
    content: "内容",
    ...
    managedReadOnly: "由 Tutti 管理",
    model: "模型",
    modelPlan: "Model Plan",
    orchestrationIntensity: "编排强度（0–100）",
    outputs: "输出产物",
    parallelizable: "可并行",
    priority: "优先级",
    provider: "Provider",
    recentRuns: "最近运行",
    quotaWaterline: "订阅额度水位线（%）",
    reasoningIntensity: "推理强度（0–100）",
  ...
  messages: {
    ...
    managedReadOnlyTooltip: "此任务由 Tutti 管理，请前往来源对话修改",
    managedSourceUnavailable: "来源对话不可用",
    modifyManagedPrompt:
      "请在当前 Tutti 计划中修改 {{reference}}，保留已有计划上下文，暂不执行",
