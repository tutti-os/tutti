...
const issueManagerEn = {
  actions: {
    ...
    adjustInTaskConversation: "Adjust in task conversation",
  ...
  labels: {
    ...
    managedReadOnly: "Managed by Tutti Mode",
    model: "Model",
  ...
  messages: {
    ...
    managedSourceUnavailable: "The task conversation is unavailable.",
    adjustManagedPrompt:
      "Please adjust {{reference}} in this Tutti Mode plan. Keep the existing plan context and do not execute it yet.",
...
const issueManagerZhCN = {
  actions: {
    ...
    minimizeWindow: "最小化",
    moreActions: "更多操作",
    adjustInTaskConversation: "去任务对话调整",
  ...
  messages: {
    ...
    managedReadOnlyTooltip: "当前任务由 Tutti Mode 管理，无法直接编辑",
    managedSourceUnavailable: "任务对话不可用",
    adjustManagedPrompt:
      "请在当前 Tutti Mode 计划中调整 {{reference}}，保留已有计划上下文，暂不执行",
