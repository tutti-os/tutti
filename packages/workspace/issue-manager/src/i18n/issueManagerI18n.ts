...
const issueManagerEn = {
  actions: {
    ...
    continueRemainingTasksManually: "Continue remaining tasks manually",
    cancel: "Cancel",
    ...
    lowerIntensityAndContinue: "Lower intensity and continue",
  ...
  labels: {
    ...
    budgetSoftLimited:
      "The Issue has reached its soft budget limit. Running work stays active; new dispatch is paused.",
    ...
    remainingQuota: "Remaining subscription quota",
...
const issueManagerZhCN = {
  actions: {
    ...
    continueRemainingTasksManually: "手动继续剩余任务",
    cancel: "取消",
    clearSearch: "清空搜索",
    closeWindow: "关闭",
    ...
    maximizeWindow: "最大化",
    lowerIntensityAndContinue: "降低强度并继续",
    minimizeWindow: "最小化",
    moreActions: "更多操作",
    openAgentSession: "打开 Agent 会话",
    openPlanningSession: "打开规划会话",
    openReference: "打开",
    refresh: "刷新",
