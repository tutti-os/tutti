...
packages/workspace/terminal
  ...
  scrollback, input queue, explicit terminal copy/paste shortcuts, and
  workbench node helpers. Clipboard access stays on the renderer platform API;
  host-specific native clipboard IPC remains outside this package.
