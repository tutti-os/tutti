...
| `TUTTI_MODEL_PLAN_API_KEY`  | [Model Access Plans](../architecture/model-access-plans.md)                                                | Daemon-managed, per-session credential injection; not a user-configurable override and never safe to log or persist. |
