...
- [Workspace App JavaScript Bridge](./workspace-app-javascript-bridge.md)
...
| Workspace App `window.tuttiExternal`, host adapters, capabilities, or public JSB behavior                                   | [Workspace App JavaScript Bridge](./workspace-app-javascript-bridge.md), [Desktop Layering](./desktop-layering.md), and [npm Package Release](./npm-package-release.md)                          | `pnpm --filter @tutti-os/workspace-external-core test`, desktop adapter tests, `pnpm check:electron-runtime-boundaries`, and `pnpm release:pack:check`                |
