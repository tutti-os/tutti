...
> {
  ...
  return {
    ...
    tuttidClient: {
      ...
      listWorkspaceModelPlans: fail,
      createModelPlan: fail,
      detectModelPlan: fail,
      recommendWorkspaceModels: fail,
      deleteModelPlan: fail,
      getModelPlan: fail,
      updateModelPlan: fail,
      duplicateModelPlan: fail,
      setModelPlanEnabled: fail,
      listModelPlanReferences: fail,
      listAgentModelBindings: fail,
      setAgentModelBinding: fail,
