        ...
        <div className="min-w-0">
          ...
          <p className="m-0 mt-1 truncate text-[11px] leading-[1.3] text-[var(--text-secondary)]">
            {[
              ...
              t(
                plan.billingMode === "subscription_quota"
                  ? "workspace.settings.apps.modelPlans.billingSubscriptionQuota"
                  : "workspace.settings.apps.modelPlans.billingApiMetered"
              ),
          ...
          <p className="m-0 mt-1 truncate text-[11px] leading-[1.3] text-[var(--text-secondary)]">
            {compatibleTargets.length > 0
              ? t("workspace.settings.apps.modelPlans.compatibleAgents", {
                  agents: compatibleTargets
                    .map((target) => target.name)
                    .join(", ")
                })
              : t("workspace.settings.apps.modelPlans.compatibleAgentsNone")}
          </p>
        </div>
        {confirmingDelete ? (
