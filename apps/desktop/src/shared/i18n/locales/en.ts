  ...
  workspace: {
    ...
    workbenchDesktop: {
      ...
      fileShare: {
        ...
        copyFailed: "Couldn't copy the optimization instruction.",
        copyInstruction:
          "File {{fileName}}, received comment {{comment}}. Please improve it based on the comment.",
        copyInstructionLabel: "Copy optimization instruction",
        copySuccessDescription:
          "Send the instruction to your agent to improve the file based on the comment.",
        copySuccessTitle: "Instruction copied",
        currentFileFromConversation:
          "This file was generated by this conversation",
        demoConversationUnavailable:
          "Opening the full conversation is not available in this demo.",
        demoConversationUpdatedAt: "Updated {{updatedAt}}",
        demoConversationWith: "Conversation between {{owner}} and {{agent}}",
        demoCommentAlice:
          "The three-part conclusion is very clear. Consider adding ByteDance HiAgent to the domestic section; it is often requested for enterprise private deployment.",
        demoCommentAliceTimestamp: "Yesterday 16:42",
        demoCommentBob:
          "The CrewAI user count should cite its source. The official blog and GitHub use noticeably different measures.",
        demoCommentBobTimestamp: "Yesterday 18:07",
        demoCommentOwner:
          "Got it. I'll add HiAgent and clarify the measurement in the next version before the end of today.",
        demoCommentOwnerTimestamp: "Today 09:15",
        demoFileContentType: "Markdown",
        demoFileName: "agent-platforms-research.md",
        demoFileOwner: "M",
        demoOwnerName: "Maya Zhou",
        demoMarkdownSource: `# AI Agent Platform Research

> Research date: 2026-06-27. Scope: domestic and international products whose core value includes user-built agents and multi-agent collaboration.

## 1. Key findings

These products span three forms, with different emphasis on each capability:

| Form | Custom agents | Multi-agent collaboration | Examples |
| --- | --- | --- | --- |
| Consumer agent stores | ✅ Core | Partially supported | GPTs, Coze, Tencent Yuanqi |
| Enterprise low-code builders | ✅ Core | ✅ Core | Copilot Studio, Alibaba Bailian, Dify |
| Developer multi-agent frameworks | ✅ | ✅✅ Core capability | CrewAI, LangGraph, AutoGen |`,
        demoReportBody:
          "This shared file contains a preview. Switch to Source to view the complete Markdown.",
        demoReportTitle: "AI Agent Platform Research",
        demoUserMessage:
          "Research platforms in China and abroad that focus on user-built agents and multi-agent collaboration. Rank them by awareness or user base, and produce a Markdown report.",
        demoAgentAcknowledgement:
          "Understood. I will cover consumer agent stores, enterprise low-code platforms, and developer frameworks, and separately identify estimation methods in the sources.",
        demoAgentResult:
          "Research complete: 14 products, 6 international and 8 domestic. The strongest examples are Coze, Tencent Yuanqi, and Copilot Studio for low-code; and CrewAI, LangGraph, and AutoGen for developers. The report is ready.",
        demoUserInitial: "M",
        ...
        justNow: "Just now",
        linkedConversationTitle: "AI Agent platform competitive research",
        loading: "Loading shared file...",
        openFullConversation: "Open full conversation in Tutti",
        panelClose: "Close file share panel",
        preview: "Preview",
        productName: "Tutti.",
        send: "Send",
        source: "Source"
